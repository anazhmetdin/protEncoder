                ...
                for j in range(len(seq)):
                    for k in range(len(seq)):
                        if k <= j:
                            ...
                            Js = ['L', 'I']
                            if seq[j] == 'X':
                                seq[j] = Xs[random.randint(0, len(Xs)-1)]
                            if seq[k] == 'X':
                                seq[k] = Xs[random.randint(0, len(Xs)-1)]
                            if seq[j] == 'B':
                                seq[j] = Bs[random.randint(0, len(Bs)-1)]
                            if seq[k] == 'B':
                                seq[k] = Bs[random.randint(0, len(Bs)-1)]
                            if seq[j] == 'Z':
                                seq[j] = Zs[random.randint(0, len(Zs)-1)]
                            if seq[k] == 'Z':
                                seq[k] = Zs[random.randint(0, len(Zs)-1)]
                            if seq[j] == 'J':
                                seq[j] = Js[random.randint(0, len(Js)-1)]
                            if seq[k] == 'J':
                                seq[k] = Js[random.randint(0, len(Js)-1)]
                            if seq[j] == 'U':
                                seq[j] = 'C'
                            if seq[k] == 'U':
                                seq[k] = 'C'
